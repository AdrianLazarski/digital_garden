...
---
> [!note] Definicja
> Złożony [[Koncepcja – Typ danych|typ danych]], grupujący powiązane ze sobą dane różnego typu w jednym obszarze pamięci. 
...
- Struktura może mieć własne [[Pole (programowanie)|pola]], [[Metoda (programowanie)|metody]], a nawet [[konstruktor]]. 