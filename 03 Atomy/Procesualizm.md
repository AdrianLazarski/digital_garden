...
- Zdarzenie to najbardziej konkretny fakt, jaki się daje oddzielnie ująć. Jest on "tu" i "teraz", nie może być "tam" i "potem".
- Rzeczywistość to ciąg procesów, które tworzą to, co nazywa się konkretem. 
- Każdy obiekt jest aktualnym bytem, który ciągle przechodzi w kolejny byt aktualny, "chwytający przeszłość. Aktualne byty nie są trwałymi składnikami rzeczywistości, lecz podstawowym wyrazem procesu przemienienia. 
