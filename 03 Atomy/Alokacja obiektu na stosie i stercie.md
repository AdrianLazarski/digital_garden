...
Na **stosie** rezerwowana jest przestrzeń na zmienną `nazwa`. Ma stały rozmiar.
...
4. Następnie procesor przeskakuje do kodu [[Konstruktor|konstruktora]], który wykonuje instrukcje przypisania wartości do konkretnych [[Pole (programowanie)|pól]]. Przydziela im przygotowane wcześniej miejsce na **stercie**. 
5. Następnie adres początkowy bloku pamięci na 