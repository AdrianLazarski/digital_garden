...
- Dano ludzi do składania Bionicle. Wszyscy badani wiedzieli, że po zakończeniu ich pracy Bionicle będą rozmontowane, by kolejne grupy mogły budować.
	...
	- Druga grupa miała płacone 2 dolary za każdego bionicla, ale rozbierano ich dzieła na ich oczach. Budowali średnio 7 bionicli.
	- W tej drugiej grupie nie miało znaczenia nawet to, czy ktoś lubi klocki czy nie.
- Podobny eksperyment z kartkami zadrukowanymi losowymi ciągami liter, na których badani mieli znajdować pary. Za pierwszą kartkę dostawali 50 centów, za każdą kolejną 5 centów mniej.
	- W grupie "docenianej" uczestnicy pisali na kartkach swoje imię i nazwisko, a prowadzący sprawdzał ich kartki.
	- W grupie "ignorowanej" nie pisali imion na kartkach, a prowadzący je po prostu odkładał bez zerkania.
	- W grupie "niszczonej" prowadzący w ogóle nie zwracał uwagi na badanych, po prostu wrzucał kartkę do niszczarki.
