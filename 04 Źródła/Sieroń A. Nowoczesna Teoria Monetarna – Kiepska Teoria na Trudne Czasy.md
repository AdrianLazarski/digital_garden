...
- Płacenie podatków płaceniem podatkami, ale MMT nie tłumaczy czemu ludzie używaja państwowego pieniądza jako środka wymiany.
...
- logika podpowiada, że produkcja musi poprzedzać opodatkowanie, ponieważ podatki obciążają ostatecznie działalność produkcyjną.
	- <mark style="background:#ff4d4f">Nie widzę w tym nic logicznego. Opodatkowanie może zmusić kogoś do działalności produkcyjnej.</mark>
- Przez większość ludzkiej cywilizacji istniał pieniądz towarowy w postaci złotych i srebrnych monet, których państwo nie mogło wykreować z niczego
- Innym przykładem jest używanie papierosów w obozach jenieckich jako środka wymiany czy rozwój kryptowalut w ostatnich latach. BTC nie jest pieniądzem, ale jest środkiem wymiany i państwo i podatki nie stały za jego powstaniem.
	- W sumie chęć unikania podatków mogła stać.
- rządy krajów zachodnich outsourcują kreację pieniądza do sektora bankowego i podlegają różnorakim ograniczeniom, takim chociażby jak istnienie formalnie niezależnych banków centralnych i zakaz debetu na kontach rządowych w nich utrzymywanych. Ergo MMT nie opisuje stanu faktycznego.
...
- Dla MMT emisja obligacji nie jest zaciąganiem długu, lecz „narzędziem, za pomocą którego bank centralny osiąga określone poziomy stopy procentowej” (Wray, s. 159)
	- Wydatki rządowe mają powodować wzrost depozytów bankowych należących do beneficjentów owych wydatków, a to ma prowadzić do obniżenia oprocentowania rezerw. By temu przeciwdziałać, nadwyżkowe rezerwy zamienia się na obligacje.
- Opiera się to na założeniu, że wydatki rządu jedynie kredytują konta bankowe beneficjentów wydatków, ale nie obciążają konta Skarbu Państwa w banku centralnym. 
- W rzeczywistości wielkość depozytów i rezerw nie ulega zmianie, lecz następuje jedynie transfer.
- Opis MMT pasuje do wydatków banku centralnego, a nie Skarbu Państwa.
	- Nasuwa się również pytanie, dlaczego rząd USA (ale także rządy innych krajów) emitował obligacje po Wielkiej Recesji, gdy stopa oprocentowania rezerw federalnych spadła już w okolice zera i przestała tak silnie zależeć od wielkości rezerw bankowych, które znacznie się powiększyły.
- Sieroń: rządy mogą się zadłużać tylko wtedy, gdy obywatele odłożą pewne oszczędności, które zgodzą się przekazać rządowi.
	- Ememciarze sami to poniekąd przyznają, mówiąc, że drukowanie hajsu pozwala na zaangażowanie nieużywanych zasobów.
- Według Wray’a (s. 68) nadwyżki budżetu federalnego za Clintona były „po prostu skutkiem ubocznym wydatków sektora prywatnego finansowanych deficytem”. Niejasne jest jednak, w jaki sposób sektor prywatny zadłuża się w rządzie, co pokazuje, że to całe podejście oparte na bilansach sektorowych jest mocno podejrzane.
